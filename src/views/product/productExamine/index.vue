...
<!--                            <el-cascader v-model="tableFrom.cate_id" class="selWidth" :options="merCateList" :props="props" clearable @change="getList(1)" />-->
<!--                        </el-form-item>-->
...
<!--                        </el-form-item>-->
                        <el-form-item label="商品搜索：" >
                            <el-input v-model="tableFrom.keyword" placeholder="请输入商品名称，关键字，产品编号" class="selWidth" @change="getList()">
            ...
            <el-button v-show="Number(tableFrom.type) < 3" size="mini" style="margin-left: 0px" @click="batchOff">批量下架</el-button>
...
<!--            </el-table-column>-->
            ...
            <el-table-column key="8" label="操作" min-width="100" fixed="right" align="center">
                <template slot-scope="scope">
                  <router-link
                    :to="{path: roterPre + '/product/addProduct/' + scope.row.product_id}"
                  >
                    ...
                    <template v-if="tableFrom.type !== '7'">
                        <el-button v-if="scope.row.status == 1" type="text" size="small" @click="toOff([scope.row.product_id])">下架</el-button>
                        <el-button v-else disabled="true"> 已下架 </el-button>
                    </template>
                    
                    <template v-if="tableFrom.type === '7'">
                      <el-button  type="text" size="small" @click="toOn([scope.row.product_id])">上架</el-button>
                    </template>
                </template>
            </el-table-column>
        </el-table>
