  ...
  <div class="divBox" v-loading.fullscreen.lock="fullscreenLoading">
    <el-card class="box-card">
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini" class="table"
        ...
        <el-table-column label="订单编号" min-width="230">
        ...
        <el-table-column label="操作" min-width="180" fixed="right" align="center">
          ...
          <template slot-scope="scope">
           ...
           <!-- <el-button type="text" size="small" v-if="scope.row.paid === 0 && scope.row.is_del === 0"
              @click="edit(scope.row.order_id)">改价</el-button> -->
            <el-button type="text" size="small" class="mr10" v-if="
                        scope.row.paid === 1 &&
                        scope.row.status != -1 &&
                        scope.row.is_del === 0
                    " @click.native="tuikuan(scope.row.order_id)">C退款</el-button>
            <!-- <el-button type="text" size="small" class="mr10" v-if="
  ...
  export default {
    ...
    methods: {
      ...
      getList(num) {
        ...
        orderMerListApi(this.tableFrom)
          .then(res => {
