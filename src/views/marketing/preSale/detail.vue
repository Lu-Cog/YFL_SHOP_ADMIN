    ...
    <div v-loading="loading">
      <div class="box-container">
        ...
        <div class="acea-row">
          ...
          <div v-if="formValidate.presell_type === 1"  class="list sp"><label class="name">预售成功/参与人数：</label>{{ formValidate.tattend_one.pay + '/' + formValidate.tattend_one.all }}</div>
          <div v-if="formValidate.presell_type === 2"  class="list sp"><label class="name">第一阶段(定金支付)成功/参与人数：</label>{{ formValidate.tattend_one.pay + '/' + formValidate.tattend_one.all }}</div>
          <div v-if="formValidate.presell_type === 2"  class="list sp"><label class="name">第二阶段(尾款支付)成功/参与人数：</label>{{ formValidate.tattend_two.pay + '/' + formValidate.tattend_two.all }}</div>
