        ...
        <div class="container">
          <el-form :inline="true">
            ...
            <el-form-item label="领取人：" class="mr10">
              <el-input v-model="tableFromIssue.username" placeholder="请输入领取人" class="selWidth" @change="getIssueList">
                <el-button slot="append" icon="el-icon-search" @click="getIssueList" />
              </el-input>
            </el-form-item>
            <el-form-item label="优惠劵：" class="mr10">
              <el-input v-model="tableFromIssue.coupon_id" placeholder="请输入优惠劵ID" class="selWidth" @change="getIssueList">
                <el-button slot="append" icon="el-icon-search" @click="getIssueList" />
              </el-input>
            </el-form-item>
          </el-form>
