    ...
    <div v-loading="loading">
      <div class="box-container">
        ...
        <div class="acea-row">
          ...
          <div class="list sp"><label class="name">助力人数：</label>{{ formValidate.assist_user_count }}</div>
          ...
          <div class="list sp"><label class="name">助力成功/参与人数：</label>{{ formValidate.pay + '/' + formValidate.all }}</div>
