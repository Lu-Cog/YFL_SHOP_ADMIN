  ...
  <div class="divBox">
    <el-card class="box-card">
        ...
        <div class="container">
          <el-form size="small" inline label-width="120px">
            ...
            <el-form-item label="商品搜索：">
              <el-input v-model="tableFrom.keyword" placeholder="请输入商品名称/ID" class="selWidth" @change="getList(1)">
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini">
        ...
        <el-table-column prop="assist_count" label="抢多多总人数" min-width="90" />
        <el-table-column prop="assist_user_count" label="团规模人数" min-width="90" />
        <el-table-column prop="assist_hour" label="超时时间(小时)" min-width="90" />
        <!-- <el-table-column label="团规模人数" min-width="60">
          <template slot-scope="scope">
        ...
        <el-table-column v-if="tableFrom.presell_type === '1'" label="助力成功人数/参与人数" min-width="80" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" min-width="150" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.product_status === 0" type="text" size="small"
              @click="toReview(scope.row.product_assist_id)">审核</el-button>
            <el-button type="text" style="margin-left:50px" size="small"
              @click="messageMerchantQdd(scope.row.product_assist_id)">管理参加商户</el-button>
