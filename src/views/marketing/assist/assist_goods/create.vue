        ...
        <div v-show="currentTab === 1">
          ...
          <el-row :gutter="24">
            <el-col v-bind="grid2">
              <el-form-item label="活动时间：" required>
                <el-date-picker v-model="assist_date" type="datetimerange" range-separator="至" start-placeholder="开始日期"
                  end-placeholder="结束日期" align="right" @change="onchangeTime" />
              </el-form-item>
            </el-col>
            <el-col v-bind="grid2">
            ...
            <!-- <el-col v-bind="grid2">
                    <el-form-item label="用户抢多多次数：" prop="assist_count">
            ...
            <el-col v-bind="grid2">
              <el-form-item label="单位：" prop="unit_name">
                <el-input v-model="formValidate.unit_name" placeholder="请输入单位" style="width: 250px;" />
              </el-form-item>
            </el-col>
            <!-- <el-col v-bind="grid2">
            ...
            <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24">
              ...
              <el-form-item v-if="formValidate.spec_type === 0">
                <el-table :data="OneattrValue" border class="tabNumWidth" size="mini">
                  ...
                  <el-table-column align="center" label="抢多多价" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model.number="scope.row['assist_price']" type="number" class="priceBox" :min="0"
                        :max="scope.row['price']" @blur="limitPrice(scope.row)" />
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column align="center" label="限量" min-width="80">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row['stock']" type="number" class="priceBox"
                        :max="scope.row['old_stock']" :min="0" />
                    </template>
                  </el-table-column>
          ...
          <el-row :gutter="24">
            <el-form-item v-if="formValidate.spec_type === 1" class="labeltop" label="规格列表：">
              <el-table ref="multipleTable" :data="ManyAttrValue" tooltip-effect="dark" highlight-current-row
                ...
                <el-table-column align="center" label="限量" min-width="80">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row['stock']" type="number" class="priceBox" :min="0"
      ...
      getInfo(id) {
        ...
        this.$route.params.id ? assistProDetailApi(id).then(async (res) => {
            ...
            if (this.formValidate.spec_type === 0) {
              ...
              // });
              this.$set(this.OneattrValue[0], 'assist_price', this.OneattrValue[0].assistSku.assist_price ? this
                .OneattrValue[0].assistSku.assist_price : 0)
              this.$set(this.OneattrValue[0], 'stock', (this.OneattrValue[0].assistSku ? this.OneattrValue[0]
                .assistSku.stock : this.OneattrValue[0].old_stock))
            } else {
              this.ManyAttrValue = info.product.attrValue;
              this.ManyAttrValue.forEach((val, i) => {
                this.attrInfo[Object.values(val.detail).sort().join("/")] = val;
                this.$set(this.ManyAttrValue[i], 'assist_price', (this.ManyAttrValue[i].assistSku && this
                    .ManyAttrValue[i].assistSku.assist_price) ? this.ManyAttrValue[i].assistSku.assist_price :
                  0)
                this.$set(this.ManyAttrValue[i], 'stock', (this.ManyAttrValue[i].assistSku ? this.ManyAttrValue[
                  i].assistSku.stock : this.ManyAttrValue[i].old_stock))
          ...
          if (valid) {
            ...
            this.$route.params.id ?
              ...
              .then(async (res) => {
                ...
                this.$message.success(res.message);
                this.$router.push({
                  path: this.roterPre + "/marketing/assist/goods_list",
                });
                this.$refs[name].resetFields();
                this.formValidate.slider_image = [];
                this.loading = false;
