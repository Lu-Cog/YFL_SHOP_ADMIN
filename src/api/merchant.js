...
export function merchantDetailApi(id) {
  return request.get(`system/merchant/detail_local/${id}`)
}

/**
 * @description 商户编辑 -
 */
export function merchantGroupListApi() {
  return request.get(`system/merchant/group_list`)
}
/**
 * @description 修改 -
 */
export function merchantUpdataApi(data,id) {
  return request.post(`system/merchant/update_local/${id}`,data)
}
/**
 * @description 地址 -- 列表
 */
export function merchantAraeApi(id) {
  return request.get(`system/merchant/address_list/${id}`)
}
/**
...
/**
 * @description 商户列表2 -- 列表
 */
export function merchantLstLocalApi(data) {
  return request.get('system/merchant/lst_local', data)
}
/**
 * @description 商户列表 -- 列表
 */
 ...
 * @description 查号
 */
export function checkPhone(type,data) {
  return request.get(`system/merchant/check_phone/${type}`,data)
}
