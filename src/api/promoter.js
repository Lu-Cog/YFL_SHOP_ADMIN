 ...
 * @description 后台分佣 -- 手动
 */
export function promoterApi(data) {
  return request.get('order/auto_fanli_month', data)
}
/**
 * @description 分销员 -- 列表
 */
...
export function promoterZbListApi(data) {
  return request.get('user/promoter/zblst', data)
}
...
export function spreadZbListApi(uid, data) {
  return request.get(`user/spread/zblst/${uid}`, data)
}
/**
