...
/**
 * @description 用户列表 -- 设置tuijianren
 */
export function changeTjrApi(id) {
  return request.get(`user/change_tjr/form/${id}`)
}


export function changeAccountApi(id) {
  return request.get(`user/change_account/form/${id}`)
}
/**
...
/**
 * @description 用户等级 -- 查看单个
 */
export function activityDetail(id) {
  return request.get(`store/product/group/${id}`)
}
...
export function saveActivity(id,data) {
  return request.post(`store/product/save_group/${id}`,data)
}

/**
 * @description 用户等级价格清单
 */
export function productAllApi(id) {
  return request.get(`store/product/all_group/${id}`)
}
...
export function getBankcard(data) {
  return request.get(`user/bankcard/lst`,data)
}

/**
 * @description 用户列表 -- 编辑用户
 */
export function cardUpdateApi(id) {
  return request.get(`user/bankcard/update/form/${id}`)
}

/**
 * @description 用户列表 -- 编辑用户
 */
export function cardAddApi() {
  return request.get(`user/bankcard/create/form`)
}
...
export function setDefault(id) {
  return request.post(`user/bankcard/set_default/${id}`)
}

/**
 * @description 用户列表 -- 编辑用户
 */
export function deleteCApi(id) {
  return request.delete(`user/bankcard/delete/${id}`)
}
